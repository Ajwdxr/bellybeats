...
import { Activity, Mail, Lock, LogIn, User, Chrome, ArrowRight, Github } from "lucide-react";
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] animate-in fade-in zoom-in-95 duration-700">
      ...
      <GlassCard className="w-full max-w-sm p-8" glowColor="rgba(96, 165, 250, 0.1)">
        ...
        <p className="text-white/40 text-sm mb-6">Start tracking your baby's moments</p>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input 
                ...
                className="pl-10 glass border-white/10 text-white placeholder:text-white/20 focus:border-primary/50 transition-all font-sans"
                value={email}
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[#0a0a1a] px-2 text-white/30">Or sign up with</span>
            </div>
          </div>
        ...
        <p className="mt-8 text-center text-sm text-white/40">
          ...
          <Link href="/login" className="text-primary font-bold hover:underline inline-flex items-center gap-1 group">
            Sign in <LogIn className="w-3 h-3 group-hover:-translate-x-1 transition-transform" />
          </Link>
        </p>
      </GlassCard>
    </div>
