...
export const BABY_PROGRESS_DATA: Record<number, WeeklyProgress> = {
  ...
  34: { week: 34, size: "Buah Betik (Papaya)", emoji: "🥭", description: "The baby's central nervous system and lungs are maturing. Their immune system is getting a boost from your antibodies." },
  35: { week: 35, size: "Tembikai Susu", emoji: "🍈", description: "The baby is putting on fat quickly, especially in the shoulders. Kicks may feel more like rolls and wiggles due to tight space." },
